...
namespace MbaileyDesignsPersistence.Migrations
{
    ...
    [Migration("20250217230958_NewInit")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("blog_post_categories", b =>
                {
                    b.Property<int>("blog_post_categories_id")
                        .HasColumnType("integer");

                    b.Property<int>("blog_posts_id")
                        .HasColumnType("integer");

                    b.HasKey("blog_post_categories_id", "blog_posts_id");

                    b.HasIndex("blog_posts_id");

                    b.ToTable("blog_post_categories");
                });

            modelBuilder.Entity("project_post_categories", b =>
                {
                    b.Property<int>("project_post_categories_id")
                        .HasColumnType("integer");

                    b.Property<int>("projects_id")
                        .HasColumnType("integer");

                    b.HasKey("project_post_categories_id", "projects_id");

                    b.HasIndex("projects_id");

                    b.ToTable("project_post_categories");
                });
            ...
            modelBuilder.Entity("blog_post_categories", b =>
                {
                    b.HasOne("MBaileyDesignsDomain.BlogCategory", null)
                        .WithMany()
                        .HasForeignKey("blog_post_categories_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MBaileyDesignsDomain.BlogPost", null)
                        .WithMany()
                        .HasForeignKey("blog_posts_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("project_post_categories", b =>
                {
                    b.HasOne("MBaileyDesignsDomain.ProjectCategory", null)
                        .WithMany()
                        .HasForeignKey("project_post_categories_id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("MBaileyDesignsDomain.Project", null)
                        .WithMany()
